      ...
      <div className="container py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
          <div className="col-start-1">
            <Typography
              variant="h3"
              className="font-serif text-theme leading-0 font-bold"
            >
              Boxing Day
            </Typography>

            <Typography variant="h3" className="font-serif font-bold leading-0">
              in Summer
            </Typography>
          </div>
          ...
          <div className="col-start-1">
            <Typography variant="h2" className="font-serif leading-0">
